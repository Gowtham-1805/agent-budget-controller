  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 16 }}>
        ...
        <MetricCard
          label="Safeguarded & Protected"
          value={usd(0.036, 4)}
          subValue="Substituted models & zero-spend blocks"
          trend={{ value: "100% Guaranteed", isPositive: true }}
          colorTheme="emerald"
          icon={CheckCircleIcon}
          sparklineData={[0, 0.01, 0.015, 0.022, 0.028, 0.032, 0.036, 0.036]}
        />
      </div>
          ...
          <div className="shadcn-card">
            ...
            <div style={{ borderTop: "1px solid var(--border-app)", marginTop: 12, paddingTop: 10, fontSize: 11.5, color: "var(--text-muted)", display: "flex", justifyContent: "space-between" }}>
              ...
              <strong style={{ color: "var(--text-primary)", fontFamily: "var(--font-mono)" }}>
                {readiness?.detail?.catalog_version || "2026-08-19.1"}
              </strong>
            </div>
          </div>
